...
<div style="text-align: center;">
	<a href="spokester1-raw-engine">🏁Play the raw game engine!🏁</a>
</div>
...
<p>
	...
	cost $8 to train.<InlineFootnote
		>Estimated based on the renting a VastAI rtx-3090 instance at 11 cents an
		hour for 72 hours.</InlineFootnote
	>
</p>
...
<p>
	...
	> Toni rides in front of the camera for 35 minutes through New York City in one
	continuous clip. They ride on busy highways and through tight intersections and
	over bridges and beneath skyscrapers. These 35 minutes portray an incredibly dynamic
...
<ul>
	...
	<li>
		The camera keeps a consistent distance from Toni about 10 feet behind him.
	</li>
	<li>
		Toni weaves between cars in multiple scenarios: gridlock, moving highways,
		empty streets
	</li>
...
<p>
	...
	noise and blurring. I additionally add a supplementary iREPA alignment loss <InlineFootnote
		...
		></InlineFootnote
	>, using a one-layer 3D CNN to predict DinoV3 features from my ViT's 6th layer
	hidden states.<InlineFootnote
...
<p>
	...
	denoising steps improved the AR reconstruction loss.
</p>
...
<div style="text-align: center;">
	<a href="https://www.youtube.com/watch?v=tNvcGdBQDj8"
		>▶️[Spokester1 Play Test - YouTube]🎬</a
	>
</div>
